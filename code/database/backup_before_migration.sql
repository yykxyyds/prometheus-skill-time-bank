...
CREATE TABLE `appeal` (
  ...
  `reason` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '申诉原因',
  `evidence` text COLLATE utf8mb4_unicode_ci COMMENT '证据描述',
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '状态: 1待处理 2处理中 3已处理',
  `result` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '处理结果',
...
CREATE TABLE `bounty` (
  ...
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '悬赏标题',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '需求描述',
...
CREATE TABLE `bounty_application` (
  ...
  `message` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '申请留言',
...
CREATE TABLE `notification` (
  ...
  `type` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '通知类型: ORDER/SYSTEM/REVIEW/BOUNTY',
...
CREATE TABLE `skill` (
  ...
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '技能标题',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '技能描述',
  `price` int NOT NULL COMMENT '定价（时间币/小时）',
  `available_time` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '可用时间段描述',
...
CREATE TABLE `skill_order` (
  ...
  `order_no` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单编号，唯一',
...
CREATE TABLE `time_transaction` (
  ...
  `type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '类型: INCOME/EXPENSE/FREEZE/UNFREEZE/GIFT',
...
CREATE TABLE `user_skill_tag` (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `tag_name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '标签名称（按时/沟通/专业/态度）',
...
-- Dump completed on 2026-05-05 15:42:50
